...
use ScobyAnalyticsDeps\Http\Client\Exception\NetworkException;
use ScobyAnalyticsDeps\Http\Promise\Promise;
use ScobyAnalyticsDeps\Psr\Http\Message\RequestInterface as Psr7RequestInterface;
use ScobyAnalyticsDeps\Psr\Http\Message\ResponseFactoryInterface;
use ScobyAnalyticsDeps\Psr\Http\Message\ResponseInterface as Psr7ResponseInterface;
use ScobyAnalyticsDeps\Psr\Http\Message\StreamFactoryInterface;
use ScobyAnalyticsDeps\Symfony\Component\HttpClient\Response\StreamableInterface;
use ScobyAnalyticsDeps\Symfony\Component\HttpClient\Response\StreamWrapper;
...
final class HttplugWaitLoop
{
    ...
    public function wait(?ResponseInterface $pendingResponse, ?float $maxDuration = null, ?float $idleTimeout = null) : int
    {
        ...
        $guzzleQueue = \ScobyAnalyticsDeps\GuzzleHttp\Promise\Utils::queue();
