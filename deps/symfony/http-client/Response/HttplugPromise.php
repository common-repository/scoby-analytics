...
use ScobyAnalyticsDeps\GuzzleHttp\Promise\Create;
use ScobyAnalyticsDeps\GuzzleHttp\Promise\PromiseInterface as GuzzlePromiseInterface;
use ScobyAnalyticsDeps\Http\Promise\Promise as HttplugPromiseInterface;
