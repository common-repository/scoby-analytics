...
use ScobyAnalyticsDeps\Symfony\Component\HttpClient\Chunk\DataChunk;
...
use ScobyAnalyticsDeps\Symfony\Component\HttpClient\Chunk\LastChunk;
            ...
            foreach ($runningResponses as $i => [$multi]) {
                ...
                foreach ($responses as $j => $response) {
                    ...
                    if ($fromLastTimeout && null !== $multi->lastTimeout) {
                        $elapsedTimeout = \hrtime(\true) / 1000000000.0 - $multi->lastTimeout;
                    }
