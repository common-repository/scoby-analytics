...
namespace ScobyAnalyticsDeps;

use ScobyAnalyticsDeps\PHPUnit\Framework\TestCase;
use ScobyAnalyticsDeps\Scoby\Analytics\Client;
use ScobyAnalyticsDeps\Spatie\Snapshots\MatchesSnapshots;
class ClientTest extends TestCase
{
    ...
    public function test_manual_setting_of_params()
    {
        ...
        $url = $Client->setIpAddress("1.2.3.4")->setUserAgent("Mozilla/Safari/Chrome")->setReferringUrl("https://www.lalala.com/kokoko?foo=bar")->setRequestedUrl("https://www.schwuppi.de/papapa?bar=baz&gclid=1122334455")->getUrl();
    ...
    public function test_blacklist_ip_range_does_not_exclude_valid_ip()
    {
        ...
        $this->assertEquals($client->logPageView(), \true);
    }
    ...
    {
        $client = new Client("dzJkeGV8TDlST1hMaXozMVFtd2o4U3hmQVIzQWxNOFh1dWZZTno=", "4GKyOvsn5GVUG+REbzspEA==");
        $httpClient = new \ScobyAnalyticsDeps\GuzzleHttp\Client(['verify' => \false]);
    ...
    {
        $client = new Client("dzJkeGV8TDlST1hMaXozMVFtd2o4U3hmQVIzQWxNOFh1dWZZTno=", "4GKyOvsn5GVUG+REbzspEA==");
        $logger = new \ScobyAnalyticsDeps\Scoby\Analytics\Logger();
