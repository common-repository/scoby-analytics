 ...
 */
namespace ScobyAnalyticsDeps\Composer;

use ScobyAnalyticsDeps\Composer\Autoload\ClassLoader;
use ScobyAnalyticsDeps\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('ScobyAnalyticsDeps\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
