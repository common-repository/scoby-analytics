...
namespace ScobyAnalyticsDeps\Psr\Log\Test;

use ScobyAnalyticsDeps\Psr\Log\LoggerInterface;
use ScobyAnalyticsDeps\Psr\Log\LogLevel;
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('ScobyAnalyticsDeps\\Psr\\Log\\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (\method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('ScobyAnalyticsDeps\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('ScobyAnalyticsDeps\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        }
