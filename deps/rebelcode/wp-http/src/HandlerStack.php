...
use ScobyAnalyticsDeps\RebelCode\WordPress\Http\Middleware\PrepareBody;
/**
...
class HandlerStack implements HandlerInterface
{
    ...
    {
        return new HandlerStack(new WpHandler($options), [Middleware::factory(PrepareBody::class), Middleware::factory(HttpErrorsToExceptions::class)]);
    }
    /**
