...
namespace ScobyAnalyticsDeps\IPLib\Address;

use ScobyAnalyticsDeps\IPLib\ParseStringFlag;
use ScobyAnalyticsDeps\IPLib\Range\RangeInterface;
use ScobyAnalyticsDeps\IPLib\Range\Subnet;
use ScobyAnalyticsDeps\IPLib\Range\Type as RangeType;
/**
 * An IPv4 address.
 */
class IPv4 implements AddressInterface
{
    ...
    public static function parseString($address, $flags = 0)
    {
        ...
        $math = new \ScobyAnalyticsDeps\IPLib\Service\UnsignedIntegerMath();
        $nums = array();
