...
use ScobyAnalyticsDeps\Http\Discovery\Exception\PuliUnavailableException;
use ScobyAnalyticsDeps\Puli\Discovery\Api\Discovery;
use ScobyAnalyticsDeps\Puli\GeneratedPuliFactory;
/**
...
class PuliBetaStrategy implements DiscoveryStrategy
{
    ...
    private static function getPuliFactory()
    {
        if (null === self::$puliFactory) {
            if (!\defined('ScobyAnalyticsDeps\\PULI_FACTORY_CLASS')) {
