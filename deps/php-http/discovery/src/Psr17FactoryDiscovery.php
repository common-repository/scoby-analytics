...
final class Psr17FactoryDiscovery extends ClassDiscovery
{
    ...
    {
        return new \ScobyAnalyticsDeps\Http\Discovery\Exception\NotFoundException('No PSR-17 ' . $type . ' found. Install a package from this list: https://packagist.org/providers/psr/http-factory-implementation', 0, $e);
    }
    /**
