...
namespace ScobyAnalyticsDeps\Spatie\Url;

use ScobyAnalyticsDeps\Psr\Http\Message\UriInterface;
use ScobyAnalyticsDeps\Spatie\Macroable\Macroable;
use ScobyAnalyticsDeps\Spatie\Url\Exceptions\InvalidArgument;
